...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#09211c]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.28),transparent_34%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.24),transparent_36%)]" />
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        <div>
          ...
          <h1 className="mt-6 max-w-4xl text-5xl font-black tracking-tight text-white sm:text-6xl lg:text-7xl">
            One bright workspace for ASL, WSL, and ISL.
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link href="/translate" className="inline-flex items-center justify-center rounded-full bg-amber-300 px-6 py-3 text-base font-black text-emerald-950 transition hover:bg-amber-200">
              Open translator
            </Link>
        ...
        <div className="rounded-[2rem] border border-white/20 bg-white/10 p-4 shadow-2xl shadow-black/30 backdrop-blur">
          <div className="rounded-[1.5rem] border border-white/10 bg-[#071511]/90 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-teal-100/70">Live workspace</p>
                ...
                <div key={language.key} className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-teal-50/75">{language.region}</p>
                    </div>
