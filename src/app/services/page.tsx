      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          {services.map((service) => (
            <article key={service.title} className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-12 rounded-[2rem] border border-indigo-100 bg-indigo-50 p-8 dark:border-indigo-500/20 dark:bg-indigo-500/10">
          ...
          <ol className="mt-6 grid gap-4 md:grid-cols-3">
            <li className="rounded-3xl bg-white p-5 dark:bg-slate-950">
              <p className="text-sm font-black uppercase tracking-wider text-indigo-600 dark:text-cyan-300">Phase 1</p>
            ...
            <li className="rounded-3xl bg-white p-5 dark:bg-slate-950">
              <p className="text-sm font-black uppercase tracking-wider text-indigo-600 dark:text-cyan-300">Phase 2</p>
            ...
            <li className="rounded-3xl bg-white p-5 dark:bg-slate-950">
              <p className="text-sm font-black uppercase tracking-wider text-indigo-600 dark:text-cyan-300">Phase 3</p>
